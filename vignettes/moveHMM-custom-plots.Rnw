...
m <- fitHMM(data,
  nbStates = nstate, stepPar0 = c(200, 1000, 200, 1000, 0.01, 0.01),
...
for (s in 1:nstate) {
  ...
  hist(data$step[ind],
    col = "grey", border = 0, main = paste("State", s),
...
plot(dist_water_grid, stat[, 1],
  type = "l", col = mycols[1], ylim = c(0, 1),
