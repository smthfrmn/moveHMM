...
exGen <- function() {
  ...
  simPar <- list(
    nbAnimals = nbAnimals, nbStates = nbStates, angleMean = angleMean, stepDist = stepDist,
  ...
  par0 <- list(
    stepPar0 = stepPar0, anglePar0 = anglePar0, formula = formula, nbCovs = nbCovs, beta0 = beta0,
    delta0 = delta0
  )

  m <- fitHMM(
    data = data, nbStates = nbStates, stepPar0 = stepPar0, anglePar0 = anglePar0, beta0 = beta0,
